...
{
    public GameObject[] CharObjs;   //캐릭터의 종류
    int CharType = 0;
    ...
    void LateUpdate()
    {
        ...
        m_RifleDir = m_RFCacRot * Vector3.forward;
        //--- Rifle 방향 계산
    ...
    void CharaterChange()
    {
        ...
        int a_Hp = CharObjs[CharType].GetComponent<PlayerCtrl>().hp;
        ...
        CharObjs[CharType].GetComponent<PlayerCtrl>().hp = a_Hp;
        targetTr = CharObjs[CharType].transform;
    }

    void TransWallUpdate()
    {
